  ...
  sections: [
...

    {
      ...
      fields: [
        ...
        { name: "ramType", label: "Module Type", type: "select", options: [{ value: "DDR3", label: "DDR3" }, { value: "DDR4", label: "DDR4" }, { value: "DDR5", label: "DDR5" }] },
        { name: "ramSpeedMHz", label: "Speed (MHz)", type: "number", min: 400, max: 10000 },
        { name: "ramFormFactor", label: "Form Factor", type: "select", options: [{ value: "DIMM", label: "DIMM" }, { value: "SO-DIMM", label: "SO-DIMM" }] },
...

    {
      ...
      fields: [
        ...
        { name: "memoryTypeSupported", label: "Supported Memory Type", type: "select", options: [{ value: "DDR3", label: "DDR3" }, { value: "DDR4", label: "DDR4" }, { value: "DDR5", label: "DDR5" }] },
        ...
        { name: "pcieGenSupported", label: "PCIe Generation Supported", type: "select", options: [{ value: "Gen3", label: "Gen3" }, { value: "Gen4", label: "Gen4" }, { value: "Gen5", label: "Gen5" }] },
...

    {
      ...
      fields: [
        ...
        { name: "driveFormFactor", label: "Form Factor", type: "select", options: [
          { value: "2.5\"", label: "2.5\"" },
          { value: "3.5\"", label: "3.5\"" },
          { value: "M.2 2280", label: "M.2 2280" },
          { value: "AIC", label: "Add-in Card" },
        ]},
        { name: "driveInterface", label: "Interface", type: "select", options: [
